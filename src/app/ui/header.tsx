...
export default function Header({ white, blue }: Readonly<HeaderProps>) {
  return (
    <h1 className="text-stone-300 text-6xl uppercase font-extrabold black-ops-one-regular flex flex-col lg:flex-row text-end lg:text-start h-33 lg:h-16 mb-1">
      {white}
